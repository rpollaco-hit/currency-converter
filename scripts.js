...
const messages = {
  pt: {
    ...
    demo_mode: "Modo demonstração ativo: usando taxas simuladas. Adicione sua APP_ID para cotações em tempo real.",
  ...
  en: {
    ...
    demo_mode: "Demo mode active: using simulated exchange rates. Add your APP_ID for live rates.",
